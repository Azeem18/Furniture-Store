...
const ServicesProd = (props) => {
  ...
  return (
    <div className=" relative flex w-1/2 z-20 mr-40 mb-20">
      ...
      <div className=" mt-4">
        ...
        <p className=" w-[200px] my-2 text-sm text-justify">
          {isExpanded ? props.text : `${props.text.substr(0, 58)}.........`}
        </p>
        <button
          onClick={toggleRead}
          className=" text-sm text-neutral-900 font-semibold hover:text-neutral-500"
        >
